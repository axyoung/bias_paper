...
stereoset = pd.read_csv('../../data/intdf_gpt_para.csv')
...
train_data.to_csv('../../data/train_data/train_data_gpt_aug.csv', index=False)
test_data.to_csv('../../data/test_data/test_data_gpt_aug.csv', index=False)
...
with open('../../data/openai_ft_prompts/train_gpt_aug_norm_updated.jsonl', 'w') as f:
...
response = openai.File.create(
    file=open("../../data/openai_ft_prompts/train_gpt_aug_norm_updated.jsonl", "rb"),
    purpose='fine-tune'
)
print(response)
id = response['id']
id
# %%
# id = 'file-mLefRjQN4it5TF5C7erWLN6O'
...
openai.FineTuningJob.retrieve("ftjob-MbrtgEp088frFJWxeoB3No1W")
