...
with open('../../data/openai_ft_prompts/train_bias_role.jsonl', 'w') as f:
...
response = openai.File.create(
    file=open('../../data/openai_ft_prompts/train_bias_role.jsonl', "rb"),
    purpose='fine-tune'
)
print(response)
id = response['id']
id
# %%
# id = 'file-yT5Ebh5e47xmXLciuTSQDoZJ'
...
openai.FineTuningJob.retrieve("ftjob-mMHJtCrSH3HEXYEStaabyWH9")
