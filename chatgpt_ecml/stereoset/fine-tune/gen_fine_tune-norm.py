...
with open('../../data/openai_ft_prompts/train_norm_updated.jsonl', 'w') as f:
...
response = openai.File.create(
    file=open("../../data/openai_ft_prompts/train_norm_updated.jsonl", "rb"),
    purpose='fine-tune'
)
print(response)
id = response['id']
id
# %%
# id = 'file-svkC4nI0wGHMC4f8MNNpZqaf'
...
openai.FineTuningJob.retrieve("ftjob-DfryQvWLCUdzxcwlUQGL8iva")
