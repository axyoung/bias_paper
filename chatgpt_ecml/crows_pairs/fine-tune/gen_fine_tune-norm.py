...
with open('../data/train_2.jsonl', 'w') as f:
...
response = openai.File.create(
    file=open("../data/train_2.jsonl", "rb"),
    purpose='fine-tune'
)
print(response)
id = response['id']
id
# %%
# id = 'file-9TYudiHC8SeR39MKia4bB8ye'
...
openai.FineTuningJob.retrieve("ftjob-pErhTdbeqpVNUx2AppyaaGF8")
