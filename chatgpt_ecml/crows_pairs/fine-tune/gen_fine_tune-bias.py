...
crows_pairs = pd.read_csv('../../data/crows_pairs.csv')

# Split the data into training and test sets
train_data = pd.DataFrame()
test_data = pd.DataFrame()

# remove the columns annotations from the dataframe
crows_pairs = crows_pairs.drop(columns=['annotations'])
crows_pairs = crows_pairs.drop(columns=['anon_writer'])
crows_pairs = crows_pairs.drop(columns=['anon_annotators'])
...
id
# %%
# id = 'file-UcXxewOEKtGa7WnGLgIFpRT3'
