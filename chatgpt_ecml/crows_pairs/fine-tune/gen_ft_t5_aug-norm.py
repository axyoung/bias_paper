...
train_data.to_csv('../data/train_data_t5_aug.csv', index=False)
test_data.to_csv('../data/test_data_t5_aug.csv', index=False)
...
with open('../data/train_t5_aug_norm.jsonl', 'w') as f:
...
response = openai.File.create(
    file=open("../data/train_t5_aug_norm.jsonl", "rb"),
    purpose='fine-tune'
)
print(response)
id = response['id']
id
# %%
# id = 'file-PqFwXmzU9tj7pq9q6d1IyzC1'
...
openai.FineTuningJob.retrieve("ftjob-vSSqK2WDOeaAxpcac8k3OaiS")
